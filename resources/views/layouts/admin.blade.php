...
<head>
  ...
  <title>El noticiero | @yield('titulo')</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="/assets/img/logo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">El noticiero</span>
    </a>
    @php
      $foto = "default.png";
      if(Auth::user()->foto) {
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 El noticiero</strong> Todos los derechos reservados.
  </footer>
