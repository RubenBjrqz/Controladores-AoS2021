...
<head>
  ...
  <title>El noticiero | Iniciar sesión</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>El </b>Noticiero</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action=""{{ route('login') }}"" method="POST">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block" action="{{ __('Log in') }}">Ingresar</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
